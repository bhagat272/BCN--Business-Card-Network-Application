...
const openPicker = async (options: Options) => {
  return ImagePicker.openPicker(options);
};

const openMediaCropper = async (options: CropperOptions) => {
  return ImagePicker.openCropper(options);
};

const openPickerMultiple = (options: Options) => {
...
export { openCamera, openPicker, openPickerMultiple, openMediaCropper };
